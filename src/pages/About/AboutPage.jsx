  ...
  return (
    <div className={css.aboutWrapper}>
      ...
      <p className={css.about}>
        This site was created to provide you with information about myself and
        my projects in web development. The main goal is to show the portfolio
        of a novice web developer.
        <br />
        <br />
